...
<html class="no-js" dir="ltr" lang="en" itemscope itemtype="http://schema.org/WebSite" prefix="og: http://ogp.me/ns#">
  ...
  <body class="canhcam-develop canhcam-index-page" id="top-page">
    ...
    <header class="canhcam-header-2">
      <nav class="navbar navbar-expand-lg container"><a class="navbar-brand" href="index.html"><img src="./view/Public/img/logo.png" alt="Logo"></a>
        ...
        <div class="collapse navbar-collapse" id="CCMenuHeader">
		  ...
		  <form class='m-0' action="product/search.html" method='POST'>
          ...
          <a href="product/cart.html" class='btn btn-info mr-2 text-white'>
        ...
        <?php if(isset($_SESSION['user'])){ ?>
          <!-- Đăng nhập thành công -->
           <div class="user dropdown">
             <a class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false"><div class="box-img"><img style='width:200px; height: 200px; object-fit:contain' src="<?=$_SESSION['user']['image']?>" alt=""></div></a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item " href="user/profile.html"><i class="fas fa-user-alt"></i>Thông tin</a>
        ...
        <!-- Đăng nhập // Đăng kí -->
            <div class="ml-3">
              <a href="user/login.html" class='btn btn-warning text-white'> Đăng nhập</a>
              <a href="user/registion.html" class='btn btn-info ml-3 text-white'> Đăng kí</a>
            </div>
        <?php } ?>
        </div>
      </nav>
